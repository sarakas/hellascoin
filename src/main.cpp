...
#if defined(NDEBUG)
# error "Hellacoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xcdc5e755ba92eb49d0937ebfdf189b942a91407611f93b376aad3f5de4796f3a");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xcdc5e755ba92eb49d0937ebfdf189b942a91407611f93b376aad3f5de4796f3a");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1400360720;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084975166;
...
void static LitecoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running HELLASCOIN with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
